...
#[bench]
fn cubic_derivative(bench: &mut test::Bencher) {
    let npts = 20;
...
#[bench]
fn cubic_second_derivative(bench: &mut test::Bencher) {
    let npts = 20;
    let xs = Array1::linspace(0.0, PI, npts);
    let xs2 = Array1::linspace(0.0, PI, npts * 3);
    let ys = xs.mapv(f64::cos);
...
#[bench]
fn cubic_acc_derivative(bench: &mut test::Bencher) {
    let npts = 20;
    let xs = Array1::linspace(0.0, PI, npts);
    let xs2 = Array1::linspace(0.0, PI, npts * 3);
    let ys = xs.mapv(f64::cos);
...
#[bench]
fn cubic_acc_second_derivative(bench: &mut test::Bencher) {
    let npts = 20;
    let xs = Array1::linspace(0.0, PI, npts);
    let xs2 = Array1::linspace(0.0, PI, npts * 3);
    let ys = xs.mapv(f64::cos);
...
#[bench]
fn cubic_univariate_spline_derivative(bench: &mut test::Bencher) {
    let npts = 20;
    let xs = Array1::linspace(0.0, PI, npts);
    let xs2 = Array1::linspace(0.0, PI, npts * 3);
    let ys = xs.mapv(f64::cos);
...
#[bench]
fn cubic_univariate_spline_second_derivative(bench: &mut test::Bencher) {
    let npts = 20;
    let xs = Array1::linspace(0.0, PI, npts);
    let xs2 = Array1::linspace(0.0, PI, npts * 3);
    let ys = xs.mapv(f64::cos);
